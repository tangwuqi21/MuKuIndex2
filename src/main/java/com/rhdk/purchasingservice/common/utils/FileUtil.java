...
/** @Description: 扩展名称操作 @Author: @CreateDate: 2020/01/16 */
public class FileUtil {

  /** @Description: Java文件操作 获取文件扩展名 @Author: @CreateDate: 2020/01/16 */
  ...
  /** @Description: Java文件操作 获取不带扩展名的文件名 @Author: @CreateDate: 2020/01/16 */
  ...
  /** @Description: 重命名 @Author: @CreateDate: 2020/01/17 */
  ...
  /** @Description: 更改扩展名 @Author: @CreateDate: 2020/01/13 */
    ...
    try {
      ...
      if ("windows".equals(SystemType)) {
        ...
        throw new IllegalArgumentException(
            "SystemType可选择值为:windows和linux请检查配置文件中SystemName的取值是否正确");
      }
  ...
  /** @Description: 判断系统 @Author: @CreateDate: 2020/03/03 */
   ...
   * @param pathHead 该文件存储的磁盘为位置如：/、/test或者/test/test 通常来源与配置文件 使用时最后一级目录不要存在'/' 目录分层时切记不要使用'\'
   * @param id 该文件的唯一表示符号
  ...
  public static String createAndGetPath(
      MultipartFile fileObj, String pathHead, String id, String belongTo, String systemType) {
    try {
  ...
  public static void main(String[] args) {
    renameFile(
        "E:/attachments/document/MTU3OTI0NTAzNzc3OS0lRTYlQjUlOEIlRTglQUYlOTUlMjAlRTQlQkIlOTglRTYlQUMlQkUlRTclOTQlQjMlRTglQUYlQjclRTUlOEQlOTU=.doc",
        "E:/attachments/document/1579245037779-测试 付款申请单.doc");
  }
}
