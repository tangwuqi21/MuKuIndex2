...
public class OrderAttachmentServiceImpl extends ServiceImpl<OrderAttachmentMapper, OrderAttachment> implements IOrderAttachmentService {
    ...
    public List<Long> insertAttachmentListOfIdList(List<OrderAttachmentDTO> attachmentVoList) {
        ...
        return attachmentVoList.stream().map(a -> {
            OrderAttachment at = OrderAttachment.builder().orgfilename(a.getOrgfilename()).fileurl(a.getFileurl()).atttype(a.getAtttype()).parentId(a.getParentId())
                    .discription(a.getDiscription()).build();
    ...
    public List<OrderAttachment> selectAttachmentList(Long id) {
        ...
        return orderAttachmentMapper.selectList(queryWrapper).stream().map(a -> {
