...
public class MybatisGenerator {
  ...
  static String[] tables = new String[] {"T_ASSET_TMPL_INFO"};
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    focList.add(
        new FileOutConfig("/templates/dto.java.vm") {
          ...
          public String outputFile(TableInfo tableInfo) {
            // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
            return outPath
                + "/com/rhdk/purchasingservice/pojo/dto/"
                + tableInfo.getEntityName()
                + "DTO"
                + StringPool.DOT_JAVA;
          }
    ...
    focList.add(
        new FileOutConfig("/templates/vo.java.vm") {
          @Override
          public String outputFile(TableInfo tableInfo) {
            return outPath + "/com/rhdk/purchasingservice/pojo/vo/" + tableInfo.getEntityName() + "VO.java";
          }
        });
